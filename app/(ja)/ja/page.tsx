  ...
  return (
    <>
      ...
      <div className="shell" data-reveal>
        <HubLinkGrid
          eyebrow="攻略メニュー"
          title="知りたいことから、ページを選ぶ。"
          intro="カード、ルール、デッキ、遊び方、無料ツールを目的別にまとめています。"
          items={[
            { href: "/ja/cards", label: "カードデータ", title: "カードリスト", description: "発売時点の148枚を名前、番号、色、効果から探せます。", badge: "148枚" },
            { href: "/ja/rules", label: "公式Q&A", title: "ルール・遊び方", description: "初心者向けの基本と個別裁定をまとめて確認できます。" },
            { href: "/ja/decks", label: "デッキ例", title: "デッキレシピ", description: "トライアルデッキと初心者向け50枚デッキを見られます。" },
            { href: "/ja/guides", label: "解説記事", title: "攻略ガイド", description: "遊び方、商品選び、カードの探し方を順番に学べます。" },
            { href: "/ja/tools/deck-builder", label: "無料ツール", title: "デッキビルダー", description: "日本語カードで条件に合う50枚を作れます。", badge: "登録不要" },
            { href: "/ja/search", label: "サイト内検索", title: "まとめて検索", description: "カード、ルール、デッキ、攻略を一度に探せます。" },
          ]}
        />
      </div>
