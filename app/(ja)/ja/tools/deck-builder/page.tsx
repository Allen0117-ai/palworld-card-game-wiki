  ...
  return (
    <>
      ...
      <div className="shell section">
        <HubLinkGrid
          eyebrow="次に見るページ"
          title="カード、ルール、デッキ例を確認する。"
          intro="カードの詳細を探す、構築ルールを確認する、完成済みのデッキ例から始めることができます。"
          items={[
            { href: "/ja/cards", label: "カードリスト", title: "カードを探す", description: "名前、番号、色、効果からカードを確認できます。" },
            { href: "/ja/rules", label: "ルール・Q&A", title: "ルールを確認", description: "基本ルールと公式Q&Aをまとめて検索できます。" },
            { href: "/ja/decks", label: "デッキレシピ", title: "50枚の例を見る", description: "初心者向けの動かし方とカードの組み合わせを見られます。" },
          ]}
        />
      </div>
    </>
