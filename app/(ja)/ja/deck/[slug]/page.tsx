  ...
  return (
    <>
      ...
      <article className="article-shell">
        ...
        <EditorialByline
          locale="ja"
          reviewed={deck.modified}
          sourceStatus={deck.status === "Official Trial Deck" ? "公式商品・カード情報" : "公式カード情報と初心者向け分析"}
        />
        <ContentFreshnessPanel
          locale="ja"
          updated={deck.updated}
          verified={deck.updated}
          sourceStatus={deck.status === "Official Trial Deck" ? "公式の商品情報・カードリスト" : "公式カード情報＋初心者向け分析"}
          summary={deck.japaneseDescription}
          changeSummary={deck.status === "Official Trial Deck" ? "収録カード、商品内容、初心者向けの回し方を確認しました。" : "50枚のサンプルと日本語デッキビルダーへの導線を確認しました。"}
