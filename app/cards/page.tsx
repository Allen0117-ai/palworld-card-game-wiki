...
export const metadata: Metadata = { title: "Palworld TCG Card List – Full Database (BP01, TD01, TD02)", description: "Browse every tracked Palworld TCG card with stats, rarity, color, cost, and strategy notes." };
  ...
  return (
    <>
      ...
      <header className="page-hero shell">
        <p className="eyebrow"><span>Database</span> · BP01 + trial decks</p>
