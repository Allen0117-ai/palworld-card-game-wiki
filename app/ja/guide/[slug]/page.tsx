...
import { createBreadcrumbJsonLd, createPageMetadata, JAPANESE_SOCIAL_IMAGE, SITE_URL } from "@/lib/seo";
      ...
      <JsonLd data={[
        {
          ...
          author: { "@type": "Organization", name: "Palpagos Archive 日本語版", url: `${SITE_URL}/ja` },
        },
