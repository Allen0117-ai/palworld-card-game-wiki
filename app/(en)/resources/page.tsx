  ...
  return (
    <>
      ...
      <div className="resource-hub shell">
        ...
        <HubLinkGrid
          eyebrow="Use this wiki"
          title="Start with the task you need to finish."
          intro="Use our searchable pages for the answer first, then check the official source when the detail matters."
          items={[
            { href: "/rules", label: "Rules", title: "Find a ruling", description: "Search the rulebook, FAQ and sourced answers." },
            { href: "/cards", label: "Cards", title: "Browse the card list", description: "Check launch card text, numbers and stats." },
            { href: "/decks", label: "Decks", title: "Choose a starting deck", description: "Compare beginner plans and sample lists." },
            { href: "/tools/deck-builder", label: "Free tool", title: "Build a deck", description: "Check a 50-card list against the launch rules." },
          ]}
        />
        ...
        <section className="question-box">
          <div><p className="eyebrow">Questions &amp; corrections</p><h2>Couldn&apos;t find your answer?</h2></div>
          <p>Send the exact question or point us to a factual error. We will reply when a reliable source supports the answer and correct confirmed mistakes.</p>
