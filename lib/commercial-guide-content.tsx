...
export const commercialGuideQuickAnswers: Record<string, QuickAnswer> = {
  ...
  "palworld-tcg-first-edition-vs-reprint": {
    ...
    answer: "First Edition wording describes sealed packaging, not a proven card-level print run. The Japanese-language official account plans an additional first-edition BP01 booster shipment for late September, while the English account says a second-edition Dawn of Palpagos print run is being planned without a date. Bushiroad also says the BP01 pack-and-box spelling error will be corrected in future reprints, but it still has not published a loose-card First Edition identifier. Do not pay a loose-card premium based only on an unsupported first-print claim.",
  },
...
export const commercialGuideContent: Record<string, React.ReactNode> = {
  "palworld-card-game-products-where-to-buy": (
    <>
      ...
      <p>The Japanese-language official account said on August 20, 2026 that an additional first-edition Dawn of Palpagos booster shipment is planned for late September and recommended reserving through a nearby retailer that carries the product. The post does not name a country, exact date or quantity. The English official account separately said additional Dawn of Palpagos stock is already on the way and a second-edition print run is being planned, but it did not publish a date, quantity or regional schedule. Keep retailer estimates local rather than presenting either notice as a worldwide restock calendar.</p>
  ...
  "palworld-tcg-first-edition-vs-reprint": (
    <>
      ...
      <p>Only partly. The Japanese-language official account plans an additional first-edition BP01 booster shipment for late September, without naming a country, exact date or quantity. The English account separately says a second-edition Dawn of Palpagos print run is being planned, but gives no date, quantity, region or card-level difference. The official BP01 page confirms the packaging spelling will be adjusted in future reprints. None of these notices explains how loose booster cards could be assigned to a print run. The Trial Deck product pages separately state that included cards may be reprinted or featured in future products; that notice still does not create a BP01 card-level identifier.</p>
  ...
  "palworld-tcg-card-size-sleeves": (
    <>
      ...
      <h2>Official accessories coming from September through November</h2>
      <div className="comparison-table" role="region" aria-label="Official Palworld TCG accessory release dates and dimensions" tabIndex={0}>
        ...
        <div><span>October 30</span><p>Sleeve range tied to Legends Awaken, announced in Japanese</p><p>Not stated in the August 21 notice</p></div>
        <div><span>November 13</span><p>Rubber playmats, storage boxes and deck holders tied to Legends Awaken</p><p>Not stated in the August 21 notice</p></div>
      </div>
      <p>The measurements shown above come from the current official product listings. The Japanese-language August 21 announcements confirmed the later product categories and dates but did not publish their dimensions. A release date does not guarantee that every local store will carry every design, so check the Bushiroad retailer list or ask your store before travelling.</p>
...
export const commercialGuideSources: Record<string, GuideSource[]> = {
  "palworld-card-game-products-where-to-buy": [
    ...
    { label: "Official Japanese-language BP01 late-September shipment notice", href: "https://x.com/PalworldOCG/status/2090352524444447078" },
    { label: "Official English Dawn of Palpagos stock and second-edition notice", href: "https://x.com/PalworldOCG_EN/status/2089880025566675341" },
  ...
  "palworld-tcg-first-edition-vs-reprint": [
    { label: "Official English BP01 product page", href: "https://en.palworld-official-cardgame.com/products/bp01" },
    { label: "Official Japanese-language BP01 late-September first-edition shipment notice", href: "https://x.com/PalworldOCG/status/2090352524444447078" },
    { label: "Official English Dawn of Palpagos second-edition plan", href: "https://x.com/PalworldOCG_EN/status/2089880025566675341" },
