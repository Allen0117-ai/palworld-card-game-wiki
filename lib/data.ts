...
export const guides: Guide[] = [
  ...
  { slug: "palworld-card-game-products-where-to-buy", category: "Buying Guide", readTime: "10 min", title: "Where to Buy Palworld TCG: MSRP, Prices & Restocks", heading: "Where to Buy Palworld TCG at a Fair Price — MSRP & Restock Guide", description: "Check official Palworld TCG prices, launch-week market ranges, restock steps and safe places to find BP01 booster boxes and Trial Decks without overpaying.", updated: "August 3, 2026", published: "2026-07-31", modified: "2026-08-03", sourceStatus: "Official product prices + dated availability snapshot" },
  ...
  { slug: "palworld-tcg-card-size-sleeves", category: "Accessory Guide", readTime: "7 min", title: "Palworld TCG Card Size & Best Sleeves (63×88mm)", description: "Palworld TCG cards measure 63×88mm. Find the correct standard-size sleeves, how many you need, and simple protection choices for decks and collections.", updated: "August 3, 2026", published: "2026-08-03", sourceStatus: "Official dimensions + practical protection guide" },
