...
export const guides: Guide[] = [
  ...
  { slug: "how-to-play-palworld-card-game", category: "Start Here", readTime: "14 min", title: "How to Play Palworld TCG – Setup, Turns & Damage Rules", description: "Learn Palworld TCG in three quick steps, then follow the official setup, turn order, attacks, blocking, Damage Checks and Lucky rules.", updated: "August 10, 2026", modified: "2026-08-10", sourceStatus: "Official rules + labeled community walkthrough" },
  { slug: "palworld-card-game-deck-building-rules", category: "Rules", readTime: "8 min", title: "How Many Cards in a Palworld TCG Deck? 50 + 10", heading: "Palworld TCG Deck Building Rules — 50 Cards + 10 Souls", description: "Palworld TCG deck building rules require exactly 50 Main Deck cards and a separate 10-card Soul Deck, with up to two colors, four copies per name and eight Lucky cards.", updated: "August 7, 2026", modified: "2026-08-07", sourceStatus: "Official rules explained" },
  { slug: "red-blue-vs-green-purple-trial-deck", category: "Buying Guide", readTime: "9 min", title: "Red/Blue vs Green/Purple: which Trial Deck should you buy?", description: "Compare both Palworld starter decks, then open the verified TD01 and TD02 card lists, play patterns and beginner recommendations.", updated: "August 10, 2026", modified: "2026-08-10", sourceStatus: "Official card pool + labeled community first look" },
  { slug: "palworld-card-game-products-where-to-buy", category: "Buying Guide", readTime: "13 min", title: "Where to Buy Palworld TCG – Preorders, Canada & Europe", heading: "Where to Buy Palworld TCG — Preorders, Canada & Europe", description: "Find Palworld TCG products and BP02 preorders safely in Canada, Germany, the Netherlands and Spain using official stores and delivered-price checks.", updated: "August 7, 2026", published: "2026-07-31", modified: "2026-08-07", sourceStatus: "Official product, language and retailer guidance" },
  ...
  { slug: "palworld-tcg-rarity-guide", category: "Collecting", readTime: "7 min", title: "Palworld TCG Rarity Guide – C, U, R, RR, SP & SSP", description: "Understand Palworld TCG C, U, R, RR, SR, OSR, SP and SSP rarity labels, parallel cards and why rarity does not equal play strength.", updated: "August 7, 2026", modified: "2026-08-07", sourceStatus: "Official product + card list" },
  ...
  { slug: "palworld-card-game-2026-roadmap", category: "News Tracker", readTime: "12 min", title: "Palworld TCG Roadmap 2026 – BP02 Oct. 30 & Events", description: "Follow the confirmed Palworld TCG roadmap for 2026 and early 2027, including BP02, two December Trial Decks, the January booster, tournaments, demos and accessories.", updated: "August 10, 2026", modified: "2026-08-10", sourceStatus: "Official products and events checked August 10" },
