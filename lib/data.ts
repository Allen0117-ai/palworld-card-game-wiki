...
export const guides: Guide[] = [
  ...
  { slug: "palworld-tcg-trial-deck-upgrade-guide", category: "Deck Building", readTime: "12 min", title: "Palworld TCG Trial Deck Upgrade Guide – TD01 & TD02", description: "Upgrade TD01 Red/Blue or TD02 Green/Purple in four-card steps while preserving the resource engine, curve and every legal deck limit.", updated: "August 6, 2026", published: "2026-08-06", modified: "2026-08-06", sourceStatus: "Official Trial Deck pools + BP01 card text" },
