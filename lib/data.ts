...
export const guides: Guide[] = [
  ...
  { slug: "palworld-tcg-first-edition-vs-reprint", category: "Collector Guide", readTime: "8 min", title: "Palworld TCG First Edition vs Reprint: What Changes?", description: "Learn what First Edition packaging proves, the planned English BP01 2nd Edition, Japan-only additional first-edition shipment timing, and what loose cards still cannot prove.", updated: "August 20, 2026", published: "2026-08-03", modified: "2026-08-20", sourceStatus: "Official English 2nd Edition plan, Japan-only shipment guidance and clearly labeled unknowns" },
