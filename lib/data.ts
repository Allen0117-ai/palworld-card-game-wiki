...
export const guides: Guide[] = [
  {
    ...
    readTime: "10 min",
    title: "Palworld Booster Box – Contents, Packs & Buying Guide",
    heading: "Palworld Booster Box Guide — Packs, Cases & Contents",
    description: "Check the BP01 booster box contents, 12 packs per box, 7 cards per pack, official Japanese 12-box carton and safe buying checks.",
    updated: "August 7, 2026",
    published: "2026-07-31",
    modified: "2026-08-07",
    sourceStatus: "Official product facts + buying analysis",
  },
  { slug: "how-to-play-palworld-card-game", category: "Start Here", readTime: "14 min", title: "How to Play Palworld TCG – Setup, Turns & Damage Rules", description: "Learn Palworld TCG in three quick steps, then follow the official setup, turn order, attacks, blocking, Damage Checks and Lucky rules.", updated: "August 7, 2026", modified: "2026-08-07", sourceStatus: "Official tutorial, rules and current card text" },
  { slug: "palworld-card-game-deck-building-rules", category: "Rules", readTime: "8 min", title: "Palworld TCG Deck Building Rules – 50 Cards & 10 Souls", description: "Build a legal Palworld TCG deck with exactly 50 Main Deck cards, 10 Souls, up to two colors, four copies per name and eight Lucky cards.", updated: "August 7, 2026", modified: "2026-08-07", sourceStatus: "Official rules explained" },
  ...
  { slug: "palworld-card-game-2026-roadmap", category: "News Tracker", readTime: "12 min", title: "Palworld TCG 2026 Roadmap – BP02 Dates & Events", description: "Follow confirmed Palworld TCG 2026 release dates for Legends Awaken BP02, tournaments, demos and accessories, with unconfirmed details clearly separated.", updated: "August 7, 2026", modified: "2026-08-07", sourceStatus: "Official products and events checked August 7" },
